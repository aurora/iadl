...
wget -r -H -nc -np -nH -nd -e robots=off --domains archive.org --exclude-domains blog.archive.org -i identifiers.txt -B 'https://archive.org/download/' -A $2 1>/dev/null 2>&1
